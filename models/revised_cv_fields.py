...
class RevisedWorkItem(BaseModel):
    ...
    job_title: str = Field(
        ...,
        description="The job title for identification."
    )
    revised_summary: Optional[str] = Field(
        None,
        description="AI-suggested revised summary for this work experience."
    )
    revised_highlights: Optional[List[str]] = Field(
        None,
        description="AI-suggested revised highlights for this work experience."
    )
...
class RevisedProjectItem(BaseModel):
    ...
    name: str = Field(
        ...,
        description="The project title for identification."
    )
    revised_description: Optional[str] = Field(
        None,
        description="AI-suggested revised description for the project."
    )
    revised_highlights: Optional[List[str]] = Field(
        None,
        description="AI-suggested revised highlights for the project."
    )

class RevisedAwardItem(BaseModel):
    id: str = Field(
        ...,
        description="The unique identifier for the award item."
    )
    title: str = Field(
        ...,
        description="The award title for identification."
    )
    revised_summary: Optional[str] = Field(
        None,
        description="AI-suggested revised summary for the award."
    )
...
class RevisedPublicationItem(BaseModel):
    ...
    name: str = Field(
        ...,
        description="The publication title for identification."
    )
    revised_summary: Optional[str] = Field(
        None,
        description="AI-suggested revised summary for the publication."
    )
